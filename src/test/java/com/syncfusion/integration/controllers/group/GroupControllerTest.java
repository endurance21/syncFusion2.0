package com.syncfusion.integration.controllers.group;
...
import com.syncfusion.integration.AbstractIntegrationTest;
...
public class GroupControllerTest extends AbstractIntegrationTest {
    ...
    public void canHandleGroupMemberRemoval() throws Exception {
        ...
        fakeTJSGroup = groupService.createTJSGroup(fakeTJSGroup.getSocietyId(), "some-email-2@syncfusion.com", utilsMethods.getImposterEmail());
