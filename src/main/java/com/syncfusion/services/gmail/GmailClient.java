...
public class GmailClient {
    ...
    public String watchForInboxUpdates() throws IOException {
        ...
        WatchResponse response = getGmail().users().watch(email, new WatchRequest().setTopicName("projects/syncfusion-in/topics/forum-email-push").setLabelIds(labelIds).setLabelFilterAction(labelFilterAction)).execute();
