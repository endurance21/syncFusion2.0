...
public class GoogleService {
    ...
    @Value("${gmail.service.impersonate.user.email:nbh@nobrokerhood.in}")
    ...
    private void initGoogleDirectoryClient(Credential credential) throws IOException {
        ...
        Group group = getGroupsAPI().get("bren-mercury@nobrokerhood.in").execute();
    ...
    private void initGoogleGroupSettingClient(Credential credential) throws IOException {
        ...
        Groups groupSettings = getGroupsSettingsAPI().groups().get("test_group@nobrokerhood.in").execute();
    ...
    public Group createNewGoogleGroup(String groupEmail, String groupName) throws IOException {
        ...
        googleGroup.setDescription("This is a group created by NoBrokerHood");
        try {
