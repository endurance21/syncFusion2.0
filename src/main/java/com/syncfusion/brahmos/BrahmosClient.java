...
public class BrahmosClient {
    ...
    @Value("${brahmos.cloufunctions.createnewpost.url:http://localhost:5001/syncfusion/us-central1/createnewpost}")
    private String createNewPostUrl;
    @Value("${brahmos.cloufunctions.createnewreply.url:http://localhost:5001/syncfusion/us-central1/addreplytopost}")
    private String createNewReplyUrl;
    @Value("${brahmos.cloufunctions.createnewnestedreply.url:http://localhost:5001/syncfusion/us-central1/addnestedreply}")
    private String createNewNestedReplyUrl;

    @Value("${brahmos.cloufunctions.getforumreplies.url:http://localhost:5001/syncfusion/us-central1/getreplydata}")
