...
public class BaseController {
    ...
    public ResponseEntity<TJSResponse<Object,Object>> sendEmailViaNobrokerNotificationService(@Validated @RequestBody SendEmailRequest emailRequest) throws IOException, MessagingException {
        String messageId;
        try {
